...
Connect platforms by entering the right commands into the command box - you can type the command or click on buttons to insert them for you. Each command determines your platform's "next" or "previous" reachable location. Once the arrow points to the right platform, jump to it using the arrow keys. Make sure you've connected them correctly and try not to fall off! Sometimes, you might have to insert a new platform, delete one, or collect all the items before you can venture forth. Make your way to the last platform until you find Mama!
